...
/**
 * An AveragedBuffer stores a buffer of
 * data with constant time lookup for the
 * average value. This can be used to 
 * implement a rolling average filter.
 * @author jacob
 */
public class AveragedBuffer {
  /**
   * This value stores the default number of samples
  ...
  /**
   * Creates a buffer that will 
   * store a default number of samples,
   * as specified by DEFAULT_N
   */
  ...
  /**
   * Creates a buffer that will 
   * store a specified number of samples,
