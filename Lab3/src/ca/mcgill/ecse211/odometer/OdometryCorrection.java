/*
 * OdometryCorrection.java (0,0) is the leftmost gridline intersection. This means in the
 * correction, robot will start at approx (-15,-15) and the correction will compensate for this.
 * Final displayed XYT should be with respect to the gridlines, unlike in uncorrected odometer,
 * where start and final positions should be (0,0)
 */
